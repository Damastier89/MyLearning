...
// Можно использовать это для итерации внутри метода объекта:
const group = {
  title: "VSS Group",
  students: ["Kate", "Sergei", "Maximus"],
...
group.showList(); // VSS Group : Kate, VSS Group : Sergei, VSS Group : Maximus
...
// Стрелочные функции не имеют «arguments». Это отлично подходит для декораторов
function defer(foo, ms) {
  return function() {
...
let sayHiDeferred = defer(sayHello, 3000);
sayHiDeferred("Kate"); // Выдедит Kate через 3 секунды
